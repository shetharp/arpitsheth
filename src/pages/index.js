...
function IndexPage({ data }) {
  ...
  slides.push({
    ...
    descr: (
      <p>
        I got my certification at the Cornell <a href="https://www.engineering.cornell.edu/students/undergraduate-students/special-programs/engineering-leadership-programs/engineering">Engineering Leadership Program</a> and
        went on to become President of <a href="http://cornellthetatau.com/">Cornell Theta Tau</a> to promote career
        leadership for engineers on campus. I've spoken at the <a href="https://usasciencefestival.org/">USA Science
        & Engineering Festival</a> and NJ Governor's School.
      </p>
    ),
  ...
  slides.push({
    ...
    descr: (
      <>
        <p>
          The branding initiative I launched at <a href="http://marsrover.engineering.cornell.edu/">Cornell Mars Rover</a> helped catapult the team from underdogs to one of the most competitive.
      </p>
        <p><em>For over ten years I've been teaching myself design. It is core to how I build products and lead teams.</em></p>
      </>
    ),
